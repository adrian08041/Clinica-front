                    ...
                    <div className="flex flex-col sm:flex-row gap-6 mb-10">
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <Select value={field.value} onValueChange={field.onChange}>
                                        <SelectTrigger className="w-full" aria-invalid={!!errors.duracaoConsulta}>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                        ...
                        <div className="flex-1">
                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <Select value={field.value} onValueChange={field.onChange}>
                                        <SelectTrigger className="w-full" aria-invalid={!!errors.intervalo}>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                                            <SelectItem value="Sem intervalo">Sem intervalo</SelectItem>
